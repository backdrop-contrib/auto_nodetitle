...
is going to be replaced with the currently logged in users name. If the token module
is installed, a list of possible replacement patterns will be shown.
...
<?php return "Author: $node->name"; ?>
 ...
 You can combine php evaluation with the token module, because tokens are replaced first.
